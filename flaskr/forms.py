...
from wtforms import StringField, BooleanField, SelectField, SubmitField, DateField, RadioField, IntegerField
...
class RoomRequestForm(FlaskForm):
    ...
    start_time = SelectField('Start', choices=['06:00 AM', '06:30 AM', '07:00 AM', '07:30 AM', '08:00 AM', '08:30 AM', '09:00 AM', '09:30 AM', '10:00 AM', '10:30 AM', '11:00 AM', '11:30 AM', '12:00 PM', '12:30 PM', '01:00 PM', '01:30 PM', '02:00 PM', '02:30 PM', '03:00 PM', '03:30 PM', '04:00 PM', '04:30 PM', '05:00 PM', '05:30 PM', '06:00 PM', '06:30 PM', '07:00 PM', '07:30 PM', '08:00 PM'])
    end_time = SelectField('End', choices=['06:00 AM', '06:30 AM', '07:00 AM', '07:30 AM', '08:00 AM', '08:30 AM', '09:00 AM', '09:30 AM', '10:00 AM', '10:30 AM', '11:00 AM', '11:30 AM', '12:00 PM', '12:30 PM', '01:00 PM', '01:30 PM', '02:00 PM', '02:30 PM', '03:00 PM', '03:30 PM', '04:00 PM', '04:30 PM', '05:00 PM', '05:30 PM', '06:00 PM', '06:30 PM', '07:00 PM', '07:30 PM', '08:00 PM'])

    arrangement = RadioField('Room Arrangement:', choices=["", "", ""])

    purpose = StringField('Purpose:', validators=[InputRequired()])
    attendees = IntegerField('Number of Attendees', validators=[InputRequired()]) # make a function to pull the values in the array from the max occupancy of the room 
...
def book(room_id):
    ...
    if request.method == 'POST':
        ...
        db.execute(
            ...
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)''', 
            (reservation_id, session.get('user_id'), form.date.data, form.start_time.data, form.end_time.data, form.purpose.data, org_id, form.attendees.data, form.coffee.data, form.soda.data, 
